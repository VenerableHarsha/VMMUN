...
function AboutUs() {
  return (
    ...
    <div className='flex gap-12 justify-center flex-wrap mt-14 '>
        <div className='sm:w-5/12 sm:h-[600px] rounded-3xl w-[280px] h-[320px] bc' style={{backgroundColor:'rgba(255, 255, 255, 0.5)'}}><div className='flex justify-center mt-4'><img src={roxky} className='w-28 sm:w-40'></img></div>
        <div className='sm:text-md text-black mt-4 mx-4 para' style={{fontWeight: '400',fontSize:"1.4rem"}}>The Rotaract Club of MediKardia is a dynamic force in the realm of Rotaract and healthcare, fueled by 162 passionate medical students dedicated to service and excellence. Through a series of medico-exclusive health-related events, the club brings vital healthcare services and information to communities in need. From organizing PHC lead surveys to conducting blood donation drives and health awareness campaigns, the club leaves an indelible mark on society and its very own district, Rotaract 3191. The motto ‘Service over Self’ is striven for in ways unimaginable.</div></div>
        <div className='sm:w-5/12 sm:h-[600px] bg-pink-300 rounded-3xl w-[280px] h-[430px] bc' style={{backgroundColor:'rgba(255, 255, 255, 0.5)'}}><div className='flex justify-center mt-4'><img src={vini} className='w-24 sm:w-32'></img></div>
        <div className='sm:text-md text-black mt-1 mx-4 para' style={{fontWeight: '400',fontSize:"1.4rem"}}>
...
It would be criminal to restrict such a budding club small but talented population of UVCE. Hence, in collaboration with Medikardia, we present to you the first edition of MVMUN, in our campus!</div></div>
        ...
        <div className='sm:w-5/12 sm:h-[500px] bg-pink-300 bc rounded-3xl  flex flex-col w-[280px] h-[350px]'style={{backgroundColor:'rgba(255, 255, 255, 0.5)'}}>
       <div className='flex justify-center mt-4'> <img src={roxky} className='w-28 sm:w-40' ></img></div>
      
        <div className='sm:text-md text-black mt-5 mb-5 mx-4 para' style={{fontWeight: '400',fontSize:"1.4rem"}}>
