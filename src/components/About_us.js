...
function AboutUs() {
  return (
    ...
    <div className='flex gap-12 justify-center flex-wrap mt-14 '>
        ...
        <div className='sm:w-5/12 sm:h-[600px] bg-pink-300 rounded-3xl w-[280px] h-[470px] bc' style={{backgroundColor:'rgba(255, 255, 255, 0.5)'}}><div className='flex justify-center mt-4'><img src={vini} className='w-24 sm:w-32'></img></div>
