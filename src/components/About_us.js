...
function AboutUs() {
  return (
    <div className="h-[1250px] sm:h-[160vh] text-white flex flex-col" style={{backgroundColor:"", color:"white", backgroundImage: `url(${AboutUsBg})` , backgroundSize: 'cover', padding: "30px"}}>
