  ...
  return (
    <div className="h-[1350px] sm:h-[160vh] text-white flex flex-col" style={{backgroundColor:"#8f3b9d", color:"white", backgroundImage: `url(${AboutUsBg})` , backgroundSize: 'cover'}}>
        ...
        <div className='flex gap-12 justify-center flex-wrap mt-14 '>
            ...
            <div className='sm:w-5/12 sm:h-[440px] bg-pink-300 rounded-3xl w-[280px] h-[430px] bc'><div className='flex justify-center mt-4'><img src={vini} className='w-24 sm:w-32'></img></div>
            <div className='sm:text-md text-black mt-1 mx-4 para'>
